defmodule PhoenixContainerExampleWeb do
  @moduledoc """
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/phoenix_container_example_web/templates",
        namespace: PhoenixContainerExampleWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PhoenixContainerExampleWeb.LayoutView, "live.html"}
